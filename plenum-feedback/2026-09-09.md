...
Run: https://github.com/frankbueltge/frankbueltge.de/actions/runs/34295382551

Failing lines, verbatim from the validation log:

```
  ✗ studio/2026-09-06-nothing-near — published work without a wall text (3 days old, grace 3); a visitor opens the work and meets it cold
```
