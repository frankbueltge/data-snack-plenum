...
Run: https://github.com/frankbueltge/frankbueltge.de/actions/runs/34683557036

Failing lines, verbatim from the validation log:

```
  ✗ studio/2026-09-09-answered-by-silence — published work without a wall text (3 days old, grace 3); a visitor opens the work and meets it cold
```
