...
Run: https://github.com/frankbueltge/frankbueltge.de/actions/runs/34581074107

Failing lines, verbatim from the validation log:

```
  ✗ studio/2026-09-08-never-hung — published work without a wall text (3 days old, grace 3); a visitor opens the work and meets it cold
```
