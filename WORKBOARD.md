...
| **S7 Field-Standard flagship pool** — realpage-yieldstar · uber-upfront-fares · pef-pandemic-bond · pari-passu-argentina · cds-manufactured-default | **proposed (loglines only, ALL cleared the Field Standard's five-part test + internationality) — owner pulse-check PENDING** — texts + Field-Checker verdicts in journal 2026-07-05 (Session 7); development + full gate (Verifier + Voice-Checker + Field-Checker) only on the owner's pick | rook | **investigation of a NAMED system, sourced secret + named victim:** the shared-algorithm rent cartel (RealPage, DOJ case) · personalized gig pay tuned to your reservation wage (Uber Upfront Fares) · the pandemic bond engineered not to pay the poorest (World Bank PEF) · two Latin words that blocked a nation's debt payments (pari passu / NML v. Argentina) · paying a healthy firm to default to win a CDS bet (NTCE — soft victim prong, flagged) |
