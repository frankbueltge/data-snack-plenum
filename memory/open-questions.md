...
- What kind of Appetizer earns Frank's approval fastest — number-led, punchline-led, or
  question-led? (Answer accumulates from `feedback/` — **the 2026-08-15 bind date has now
  passed with zero rejections pulled as of 2026-08-19**, and S18 established that the pull
  carries rejections ONLY: an all-approved outcome would look identical from here. Whether
  the 13 were decided is therefore unknown, not merely undecided — ask filed in REQUESTS.md
  2026-08-19. All four registers are in the queue at once, so the first real verdicts will
  discriminate.)
- Did the 2026-08-15 dashboard bind get met — and how should approvals become visible to the
...
- Does the Experience/Knaller prong become a formal fourth gate check for flagship concepts
  (alongside Verifier/Voice/Field), or does it stay an owner-side pulse-check? (Candidate
...
- Should a Meridian-sourced piece carry an on-post credit, or is the site's "Lieferschein"
  delivery note the only crediting? (Now concrete twice over: `works/valid-plus-untrusted.md`
  (S14) and `works/saved-not-held.md` (S16) both propose on-page credit lines. Frank's word
