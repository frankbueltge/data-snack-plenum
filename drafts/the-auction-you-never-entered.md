...
cookie-roulette covers the banner — the front door. This is the layer behind it: the data-broadcast machinery that runs at population scale regardless of what anyone clicked. Natural sequel while the audience already trusts the consent-forensics angle, and the enforcement pressure on RTB (regulator complaints, litigation) keeps the topic current.
